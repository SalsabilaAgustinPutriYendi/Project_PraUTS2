...
import 'package:simulasi_uts/screen_page/page_loginAPI.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.89.194/simulasimobile/edukasi_server/getBerita.php"),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(onPressed: () {}, child: Text('Hi ... ${session.userName}', style: TextStyle(color: Colors.white), )),
          // Logout
          IconButton(
            onPressed: () {
              // Clear session
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.89.194/simulasimobile/edukasi_server/gambar_berita/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
