        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                "http://192.168.89.194/simulasimobile/edukasi_server/gambar_berita//${data?.gambar}",
                fit: BoxFit.fill,
              ),
            ),
          ),
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http
          .get(Uri.parse("http://192.168.89.194/simulasimobile/edukasi_server/getBerita.php"));
